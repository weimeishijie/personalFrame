package com.frame.webSocket.stomp.controller;

import com.frame.webSocket.stomp.entity.Greeting;
...
public class GreetingController {
    ...
    public Greeting send() {
        getSimpMessageSendingOperations().convertAndSendToUser("1", "/message", new Greeting("I am a msg from SubscribeMapping('/macro')."));
        return new Greeting("I am a msg from SubscribeMapping('/macro').");
    }
}
